...
public partial class SidebarFinancePage : ContentPage
{
    ...
    public RelayCommand NavigateToFinanceDashboardCommand { get; }
    public RelayCommand NavigateToBudgetCommand { get; }
    public RelayCommand NavigateToExpensesCommand { get; }
    public RelayCommand NavigateToRevenueCommand { get; }
    public RelayCommand NavigateToCashFlowCommand { get; }
    public RelayCommand NavigateToFinancialStatementsCommand { get; }
    public RelayCommand NavigateToFinanceReportsCommand { get; }
    public RelayCommand NavigateToUsersCommand { get; }
    public RelayCommand NavigateToSettingsCommand { get; }

    public SidebarFinancePage(RoleService roleService, IServiceProvider services)
    {
        InitializeComponent();
        ...
        NavigateToFinanceDashboardCommand = new RelayCommand(() =>
            LoadPage("Finance Dashboard", () => _services.GetRequiredService<FinanceDashboardPage>()));

        NavigateToBudgetCommand = new RelayCommand(() =>
            LoadPage("Budget", () => _services.GetRequiredService<BudgetPage>()));

        NavigateToExpensesCommand = new RelayCommand(() =>
            LoadPage("Expenses", () => _services.GetRequiredService<ExpensesPage>()));

        NavigateToRevenueCommand = new RelayCommand(() =>
            LoadPage("Revenue", () => _services.GetRequiredService<RevenuePage>()));

        NavigateToCashFlowCommand = new RelayCommand(() =>
            LoadPage("Cash Flow", () => _services.GetRequiredService<CashFlowPage>()));

        NavigateToFinancialStatementsCommand = new RelayCommand(() =>
            LoadPage("Financial Statements", () => _services.GetRequiredService<FinancialStatementsPage>()));

        NavigateToFinanceReportsCommand = new RelayCommand(() =>
            LoadPage("Finance Reports", () => _services.GetRequiredService<FinanceReportsPage>()));
