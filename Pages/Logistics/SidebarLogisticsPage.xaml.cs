...
public partial class SidebarLogisticsPage : ContentPage
{
    ...
    public RelayCommand NavigateToLogisticsDashboardCommand { get; }
    public RelayCommand NavigateToShippingCommand { get; }
    public RelayCommand NavigateToDeliveryTrackingCommand { get; }
    public RelayCommand NavigateToRoutingCommand { get; }
    public RelayCommand NavigateToSupplierManagementCommand { get; }
    public RelayCommand NavigateToFleetManagementCommand { get; }
    public RelayCommand NavigateToLogisticsReportsCommand { get; }
    public RelayCommand NavigateToUsersCommand { get; }
    public RelayCommand NavigateToSettingsCommand { get; }

    public SidebarLogisticsPage(RoleService roleService, IServiceProvider services)
    {
        InitializeComponent();
        ...
        NavigateToLogisticsDashboardCommand = new RelayCommand(() =>
            LoadPage("Logisttics Dashboard", () => _services.GetRequiredService<LogisticsDashboardPage>()));

        NavigateToShippingCommand = new RelayCommand(() =>
            LoadPage("Shipping", () => _services.GetRequiredService<ShippingPage>()));

        NavigateToDeliveryTrackingCommand = new RelayCommand(() =>
            LoadPage("Delivery Tracking", () => _services.GetRequiredService<DeliveryTrackingPage>()));

        NavigateToRoutingCommand = new RelayCommand(() =>
            LoadPage("Routing", () => _services.GetRequiredService<RoutingPage>()));

        NavigateToSupplierManagementCommand = new RelayCommand(() =>
            LoadPage("Supplier Management", () => _services.GetRequiredService<SupplierManagementPage>()));

        NavigateToFleetManagementCommand = new RelayCommand(() =>
            LoadPage("Fleet Management", () => _services.GetRequiredService<FleetManagementPage>()));

        NavigateToLogisticsReportsCommand = new RelayCommand(() =>
            LoadPage("Logistics Reports", () => _services.GetRequiredService<LogisticsReportsPage>()));
